...
@zefiros/npm-defaults/0.2.0-beta.35 linux-x64 node-v12.16.1
...
_See code: [dist/commands/ci.js](https://github.com/Zefiros-Software/npm-defaults/blob/v0.2.0-beta.35/dist/commands/ci.js)_
...
_See code: [dist/commands/create.js](https://github.com/Zefiros-Software/npm-defaults/blob/v0.2.0-beta.35/dist/commands/create.js)_
...
_See code: [dist/commands/lint.js](https://github.com/Zefiros-Software/npm-defaults/blob/v0.2.0-beta.35/dist/commands/lint.js)_
...
_See code: [dist/commands/make-release.js](https://github.com/Zefiros-Software/npm-defaults/blob/v0.2.0-beta.35/dist/commands/make-release.js)_
...
_See code: [dist/commands/release.js](https://github.com/Zefiros-Software/npm-defaults/blob/v0.2.0-beta.35/dist/commands/release.js)_
<!-- commandsstop -->
